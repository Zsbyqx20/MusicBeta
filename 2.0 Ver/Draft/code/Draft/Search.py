...
class Search_Widget(QtWidgets.QWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.labelPic(self.label_2, "./src/search.png")
    ...
    def paintEvent(self, a0: QtGui.QPaintEvent) -> None:
        ...
        genFont(painter, "./src/FontWel.ttf", 16, QtCore.QPointF(100, 38),
                "Search For", False, QtGui.QColor(255, 30, 0), "file")
        painter.end()
...
class Search_Options(QtWidgets.QWidget):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        uic.loadUi("./Search_Options.ui", self)
