...
class MainWindow(QMainWindow):
    ...
    def basicSetting(self) -> None:
        ...
        self.setWindowIcon(QIcon("./MusicBeta.ico"))
    ...
    def setBackground(self) -> None:
        ...
        pixmap = maskImage("./Resource/mainbkgx.jpg", "jpg", 480, 320, 155)
    ...
    def setFuncBtn(self) -> None:
        ...
        for i, btn in enumerate(btns):
            ...
            buttonImage(btn, f"./Resource/{srcs[i]}.png", "png")
    ...
    def downloadMusic(self) -> None:
        dirName = QFileDialog.getExistingDirectory(self, 'Choose Directory', 'C:/Users/')
        ...
        with open(f"{dirName}/{result.song}-{result.singer}.mp3", "wb") as f:
            f.write(data)
    ...
    def setSearchMode(self) -> None:
        ...
        for i, btn in enumerate(btns):
            ...
            if btn.isChecked() == False:
                addon = 'W'
            buttonImage(btn, f"./Resource/{imgs[i]}{addon}.png", "png")
    ...
    def processMode(self, id: int) -> None:
        ...
        Resource = ["Cloud", "Kugou", "Kuwo"][id]
        pm = maskImage(f"./Resource/{Resource}.png", "png", 30, 30)
        btn.setIcon(QIcon(pm))
        for i, tmpbtn in enumerate([self.cloudBtn, self.kugouBtn, self.kuwoBtn]):
            if i != id:
                pm = maskImage(
                    f"./Resource/{['Cloud', 'Kugou', 'Kuwo'][i]}W.png", "png", 30, 30)
